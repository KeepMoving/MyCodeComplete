...
public class LoginUI 
{
	...
	{   
		try {
			...
			props.load(in);
			in.close();
			this.length = Integer.parseInt(props.getProperty("model.maxLength")) * 35;
		...
		//先创建一个窗体   
		javax.swing.JFrame jf = new javax.swing.JFrame("N皇后问题");   
		  
		//设置窗体的大小   
		jf.setSize(this.length, this.length); 
