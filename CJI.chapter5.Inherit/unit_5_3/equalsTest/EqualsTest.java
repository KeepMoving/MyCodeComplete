...
public class EqualsTest 
{
	public static void main(String[] args) 
	{
		...
		Employee2 bob = new Employee2("Bob Brandson",5000,1989,10,1);
		
		System.out.println("alice1 == alice2:" + (alice1 == alice2));
		System.out.println("alice1 == alice3:" + (alice1 == alice3)); //即使初始化相同的参数，alice1和alice3的对象还是不同
...
class Employee2
{
	...
	public boolean equals(Object otherObject)
	{
		...
		//now we know otherObjext is a non-null Employee
